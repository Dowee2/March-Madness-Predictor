...
if __name__ == '__main__':
    ...
    classifiers = [
        ...
        XGBClassifier(random_state=3270, n_estimators=100, max_depth=3, learning_rate=0.1, gamma=0, subsample=0.8, colsample_bytree=0.8, tree_method='hist', device = 'cuda'),
