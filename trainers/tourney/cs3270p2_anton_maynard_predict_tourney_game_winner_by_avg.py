...
def concat_seasons():
    ...
    for season in seasons:
        ...
        try:
            season_df = pd.read_csv(f'{currdir}/MNCAATourneyDetailedResults_{season}_tourney_avg.csv')
...
if __name__ == '__main__':
    ...
    classifiers = {
        ...
        'Logistic Regression': LogisticRegression(random_state=3270, max_iter=100, penalty = None, solver = 'lbfgs', ),
